...
public class Permission  implements java.io.Serializable {
    ...
    public Permission(Date createdDate, Long createdBy, Date lastUpdatedDate, Long lastUpdatedBy, String status, Set<UserRoleScreenElement> userRoleScreenElements) {
