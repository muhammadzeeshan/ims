...
import com.ims.framework.AbstractDAO;
...
public class RoleController {
	...
	public void save(@RequestBody String body) {
		...
		roleManagementService.persist(role);
	}
	...
	public @ResponseBody String getById(@RequestParam Long roleId) {
		...
		roleManagementService.getById(Role.class, roleId);
	...
	public @ResponseBody String getAll() {
		...
		Collection<Role> roles = roleManagementService.getAll(Role.class);
